        ...
        <header class="flex flex-wrap  md:justify-start md:flex-nowrap z-50 w-full bg-white  dark:bg-neutral-800">
            <nav class="relative max-w-[85rem] w-full mx-auto md:flex md:items-center md:justify-between md:gap-3 py-4 px-4 sm:px-6 lg:px-20">
                <div class="flex justify-between items-center gap-x-1">
                    <NavLink to={'/'} className={"flex-none font-bold text-4xl text-gray-800 dark:text-white"}>
                        Garuda <span className="text-blue-500 text-2xl">日本</span>
                    </NavLink>
                        ...
                        <div class="py-2 md:py-0  flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
                            <div class="grow">
                                <div class="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
                                    ...
                                    <NavLink to={"/kanji"} className={"p-2 flex items-center text-sm text-gray-800  rounded-lg"}>
